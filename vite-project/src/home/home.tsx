...
export const Home = ({ action }: HomeProps) => {
  ...
  useEffect(() => {
    if (action && refs[action]?.current) {
      refs[action].current.scrollIntoView({
        behavior: "smooth",
        block: "start",
      });
    }
  ...
  return (
    <div className="flex flex-wrap w-full h-full justify-center items-center gap-2 lg:gap-0">
      <div className="w-full" ref={refs.Home}>
        <LandingPage />
      </div>
      <div className="w-full" ref={refs.Banner}>
        <Banner />
      </div>
      <div className="w-full" ref={refs.Best}>
        <BestDeliciousFood />
      </div>
      <div className="w-full" ref={refs.Delicious}>
        <DeliciousItem />
      </div>
      <div className="w-full" ref={refs.Black}>
        <BlackBanner />
      </div>
      <div className="w-full" ref={refs.Delivery}>
        <DeliveryChallenge />
      </div>
      <div className="w-full" ref={refs.Shop}>
        <TodaySpecialDelicious />
      </div>
      <div className="w-full" ref={refs.Trending}>
        <TrendingFoodMenu />
      </div>
      <div className="w-full" ref={refs.BurgerPizza}>
        <BurgerPizzaBanner />
      </div>
      <div className="w-full" ref={refs.AboutUs}>
        <QualityMeet />
      </div>
      ...
      <div className="w-full" ref={refs.Contact}>
        <Footer />
      </div>
    </div>
  );
