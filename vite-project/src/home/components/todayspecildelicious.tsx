...
export const TodaySpecialDelicious = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full h-full lg:h-screen">
      {/* Left Side */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 ">
        ...
        >
          ...
          <button className="flex w-[150px] h-[80px] bg-[#FFC222] rounded-[9px] justify-center  gap-2 p-4 cursor-pointer hover:shadow-lg hover:scale-105 transition duration-300 ease-in-out">
           ...
           <img src={frenchFries} alt="French Fries" className="w-[160px]  absolute right-0 bottom-0" />
        </div>
        <div className="w-full h-[350px] lg:h-full flex bg-cover bg-center flex-col p-6 relative"
