    ...
    <>
      <div className="flex flex-wrap items-center justify-center flex-col lg:flex-row w-full h-full lg:h-screen relative">
        <div className="flex flex-wrap items-center justify-center w-full max-w-7xl px-4 md:px-6 lg:px-10">
          <div className="flex items-center justify-center flex-col gap-4">
            ...
            <div className="flex items-center justify-center flex-col lg:flex-row gap-3 ">
              {/* Card1 */}
              <motion.div
                className="w-full  md:w-[300px]  lg:w-[300px]  h-[400px] flex flex-col  items-center lg:justify-center rounded-[16px] cursor-pointer hover:scale-105 transition duration-300 ease-in-out"
              ...
              {/* Card2 */}
              <motion.div
                className="w-full h-[400px]  md:w-[300px]  lg:w-[300px] lg:h-[100px] flex flex-col items-center lg:justify-center rounded-[16px] cursor-pointer hover:scale-105 transition duration-300 ease-in-out"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              {/* Card3 */}
              <motion.div
                className="w-full  md:w-[300px]   lg:w-[300px] h-[400px] flex flex-col items-center justify-center rounded-[16px] cursor-pointer hover:scale-105 transition duration-300 ease-in-out"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.img
          src={shadowBurger}
          alt="shadowBurger"
          className="hidden lg:block absolute left-2 top-40"
        ...
        />
        <motion.img
          src={shadowFrenchFries}
          alt="shadow French Fries"
          className="hidden lg:block absolute right-9 bottom-9"
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
