      ...
      <div className="w-full h-full lg:h-screen flex flex-wrap items-center justify-center flex-col">
        <div className="flex flex-wrap items-center justify-center w-full max-w-7xl  lg:w-[700px]  px-4 md:px-6 lg:px-10 mx-auto ">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:gap-2 text-center lg:text-left  ">
            {/* left */}
            <motion.div 
              className="flex flex-col justify-center items-center lg:items-start lg:ml-16 lg:px-30 "
            ...
            >
              ...
              <div className="flex items-center w-full lg:w-[400px] mb-4 justify-center lg:justify-start ">
              ...
              <div className="w-full lg:w-[500px]  mb-4 ">
                <p className="font-[Oswald] font-normal text-[14px] sm:text-[15px] md:text-[14px] lg:text-[12px] leading-[20px] sm:leading-[24px] md:leading-[20px] lg:leading-[20px] text-[#5C5C5B] align-middle">
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className="font-[Oswald] font-semibold text-[14px] sm:text-[16px] lg:text-[14px] leading-[20px] capitalize text-[#212121] align-middle">
                      Super Quality Food
                    </h3>
                    <p className="font-[Oswald] font-normal text-[13px] sm:text-[14px] lg:text-[12px] leading-[20px] text-[#212121] align-middle">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="font-[Oswald] font-normal text-[13px] lg:text-[12px] sm:text-[14px] leading-[20px] text-[#212121] align-middle">
                      A team of dreamers and doers building 
                      unique interactive music and art
                    </p>
                  </div>
